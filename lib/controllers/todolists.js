...
/*
    TodoList.update(
      { "_id": new ObjectId(req.params.id)} , sharedWith.user_id:user.user_id },
      { $set:{ sharedWith.$.name:user.name } },
      { upsert: true },
      function(err){
