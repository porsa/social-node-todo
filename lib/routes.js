...
module.exports = function(app) {
  ...
  app.post('/api/todoLists/:id/share', middleware.auth, todoLists.shareList);
  ...
  app.get('/api/OwnTodoLists', middleware.auth, todoLists.getOwnTodoLists);
  app.get('/api/SharedWithMeTodoLists', middleware.auth, todoLists.getSharedTodoLists);
  ...
  app.get('/api/friends/accepted', middleware.auth, users.getAcceptedFriends);
  ...
  //TODO what is this? to be removed? returns req.user.userInfo
